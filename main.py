...
port_sql = 3307
conexion_SQL = conexion_SQL.ConexionSQL(host="localhost", port=3307, user="root", password="agentepeke", database="casos_covid")
...
def show_graph():
    ...
    db_connection = mysql.connector.connect(
        host="localhost", port=3307, user="root", password="agentepeke", database="casos_covid"
    )
